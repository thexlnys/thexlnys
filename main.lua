...
local siriusValues = {
	...
	games = {
		BreakingPoint = {
			name = "Breaking Point",
			description = "Pemain duduk mengelilingi meja. Tujuan satu-satunya? Menjadi yang terakhir bertahan. Jalankan script ini untuk mendapatkan keuntungan tidak adil.",
			id = 648362523,
			enabled = true,
			raw = "BreakingPoint",
			minimumTier = "Free",
		...
		MurderMystery2 = {
			...
			description = "Pembunuhan telah terjadi, akankah Anda menjadi yang menemukan pembunuhnya, atau membunuh korban berikutnya? Jalankan script ini untuk mendapatkan keuntungan tidak adil.",
			id = 142823291,
			enabled = true,
			raw = "MurderMystery2",
			minimumTier = "Free",
		...
		TowerOfHell = {
			name = "Tower Of Hell",
			description = "Game parkour populer yang sulit, dengan level dan modifier acak. Jalankan script ini untuk mendapatkan keuntungan tidak adil.",
			id = 1962086868,
			enabled = true,
			raw = "TowerOfHell",
			minimumTier = "Free",
		...
		Strucid = {
			name = "Strucid",
			description = "Lawan teman dan musuh di Strucid dengan mekanik membangun! Jalankan script ini untuk mendapatkan keuntungan tidak adil.",
			id = 2377868063,
			enabled = true,
			raw = "Strucid",
			minimumTier = "Free",
		...
		PhantomForces = {
			name = "Phantom Forces",
			description = "Salah satu game FPS shooter paling populer dari tim di StyLiS Studios. Jalankan script ini untuk mendapatkan keuntungan tidak adil.",
			id = 292439477,
			enabled = true,
			raw = "PhantomForces",
			minimumTier = "Pro",
...
local siriusSettings = {
		{
			name = 'Umum',
			description = 'Pengaturan umum untuk Sirius, dari fitur sederhana hingga unik.',
		color = Color3.new(0.117647, 0.490196, 0.72549),
		minimumLicense = 'Free',
		categorySettings = {
			{
				name = 'Klien Anonim',
				description = 'Acak username Anda secara real-time di antarmuka CoreGui manapun, termasuk Sirius. Anda masih akan muncul dengan nama asli Anda kepada pemain lain di dalam game. Pengaturan ini dapat mempengaruhi performa.',
				settingType = 'Boolean',
				current = false,
			...
			{
				name = 'Mata-mata Chat',
				description = 'Ini hanya akan bekerja pada sistem chat Roblox lama. Sirius akan menampilkan bisikan yang biasanya tersembunyi dari Anda di kotak chat.',
				settingType = 'Boolean',
				current = true,
			...
			{
				name = 'Sembunyikan Tombol Toggle',
				description = 'Ini akan menghapus opsi untuk membuka smartBar dengan tombol toggle.',
				settingType = 'Boolean',
				current = false,
			...
			{
				name = 'Notifikasi Sedang Diputar',
				description = 'Ketika aktif, Sirius akan memberi tahu Anda ketika lagu berikutnya dalam antrian Musik diputar.',
				settingType = 'Boolean',
				current = true,
			...
			{
				name = 'Anti Idle',
				description = 'Hapus semua callback dan event yang terhubung ke status Idled LocalPlayer. Ini dapat memicu deteksi dari Adonis atau anti-cheat serupa.',
				settingType = 'Boolean',
				current = true,
			...
			{
				name = 'Anti Kick Berbasis Klien',
				description = 'Batalkan permintaan kick yang melibatkan Anda yang dikirim oleh klien. Ini dapat memicu deteksi dari Adonis atau anti-cheat serupa. Anda perlu bergabung kembali dan menjalankan ulang Sirius untuk mengaktifkan.',
				settingType = 'Boolean',
				current = false,
			...
			{
				name = 'Redam audio saat tidak fokus',
				settingType = 'Boolean', 
				current = true,
		...
		{
			name = 'Tombol Pintas',
			description = 'Tetapkan tombol pintas ke tindakan atau ubah tombol pintas seperti yang untuk membuka/menutup Sirius.',
		...
		{
			name = 'Performa',
			description = 'Sesuaikan dan uji pengaturan performa Roblox Anda di Sirius.',
		color = Color3.new(1, 0.376471, 0.168627),
		minimumLicense = 'Free',
		categorySettings = {
			{
				name = 'Batas FPS Buatan',
				description = 'Sirius akan secara otomatis mengatur FPS Anda ke angka ini ketika Anda membuka tab Roblox.',
				settingType = 'Number',
				values = {20, 5000},
				current = 240,
			...
			{
				name = 'Batasi FPS saat tidak fokus',
				description = 'Sirius akan secara otomatis mengatur FPS Anda ke 60 ketika Anda menutup tab atau tidak fokus dari Roblox.',
			...
			{
				name = 'Peringatan Latensi Adaptif',
				description = 'Sirius akan memeriksa latensi rata-rata Anda di latar belakang dan memberi tahu Anda jika latensi saat ini secara signifikan melebihi latensi rata-rata Anda.',
				settingType = 'Boolean',
				current = true,
			...
			{
				name = 'Peringatan Performa Adaptif',
				description = 'Sirius akan memeriksa FPS rata-rata Anda di latar belakang dan memberi tahu Anda jika FPS saat ini turun di bawah angka tertentu.',
				settingType = 'Boolean',
				current = true,
		...
		{
			name = 'Deteksi',
			description = 'Sirius mendeteksi dan mencegah segala sesuatu yang berbahaya atau berpotensi merugikan kesejahteraan Anda.',
		color = Color3.new(0.705882, 0, 0),
		minimumLicense = 'Free',
		categorySettings = {
			{
				name = 'Perisai Spasial',
				description = 'Tekan suara keras yang diputar dari sumber audio manapun di dalam game, secara real-time dengan Perisai Spasial.',
				settingType = 'Boolean',
				minimumLicense = 'Pro',
				current = true,
			...
			{
				name = 'Ambang Perisai Spasial',
				description = 'Seberapa keras suara harus untuk ditekan.',
				settingType = 'Number',
				minimumLicense = 'Pro',
				values = {100, 1000},
				current = 300,
			...
			{
				name = 'Deteksi Moderator',
				description = 'Dapatkan notifikasi setiap kali Sirius mendeteksi pemain yang bergabung ke sesi Anda yang mungkin adalah moderator game.',
				settingType = 'Boolean', 
				minimumLicense = 'Pro',
				current = true,
			...
			{
				name = 'Intersepsi HTTP Cerdas',
				description = 'Blokir permintaan HTTP/HTTPS eksternal dari pengiriman/penerimaan dan tanyakan Anda sebelum mengizinkannya berjalan.',
				settingType = 'Boolean',
			...
			{
				name = 'Intersepsi Clipboard Cerdas',
				description = 'Blokir clipboard Anda dari pengaturan dan tanyakan Anda sebelum mengizinkannya mengatur clipboard Anda.',
				settingType = 'Boolean',
				minimumLicense = 'Essential',
				current = true,
		...
		{
			name = 'Pencatatan',
			description = 'Kirim log ke URL webhook yang Anda tentukan tentang hal-hal seperti pemain bergabung dan keluar serta pesan.',
		color = Color3.new(0.905882, 0.780392, 0.0666667),
		minimumLicense = 'Free',
		categorySettings = {
			{
				name = 'Catat Pesan',
				description = 'Catat pesan yang dikirim oleh pemain manapun ke webhook Anda.',
				settingType = 'Boolean',
				current = false,
			...
			{
				name = 'URL Webhook Pesan',
				description = 'URL Discord Webhook',
				settingType = 'Input',
				current = 'Tidak Ada Webhook',

				id = 'logmsgurl'
			},
			{
				name = 'Catat PlayerAdded dan PlayerRemoving',
				description = 'Catat setiap kali pemain keluar atau bergabung ke sesi Anda.',
				settingType = 'Boolean',
				current = false,
			...
			{
				name = 'URL Webhook Pemain Ditambahkan dan Dihapus',
				description = 'URL Discord Webhook',
				settingType = 'Input',
				current = 'Tidak Ada Webhook',
...
local function queueNotification(Title, Description, Image)
	task.spawn(function()		
		if checkSirius() then
			...
			newNotification.Name = Title or "Judul Tidak Dikenal"
			newNotification.Visible = true

			newNotification.Title.Text = Title or "Judul Tidak Dikenal"
			newNotification.Description.Text = Description or "Deskripsi Tidak Dikenal"
...
local function checkLastVersion()
	...
	if lastVersion then
		if lastVersion ~= siriusValues.siriusVersion then queueNotification("Sirius telah diperbarui", "Sirius telah diperbarui ke versi "..siriusValues.siriusVersion..", periksa Discord kami untuk semua fitur dan perubahan baru.", 4400701828)  end
	end
...
local function playNext()
	if #musicQueue == 0 then currentAudio.Playing = false currentAudio.SoundId = "" musicPanel.Playing.Text = "Tidak Memutar" return end
	...
	if checkSetting("Notifikasi Sedang Diputar").current then queueNotification("Sedang Diputar", musicQueue[1].sound, 4400695581) end
...
local function addToQueue(file)
	...
	checkFolder()
	if not isfile(siriusValues.siriusFolder.."/Music/"..file) then queueNotification("Tidak dapat menemukan file", "Pastikan file audio Anda berada di folder Sirius/Music dan Anda menyertakan ekstensi file (misalnya mp3 atau ogg).", 4370341699) return end
	...
	for _, gameFound in pairs(siriusValues.games) do
		if gameFound.id == placeId and gameFound.enabled then
			...
			gameDetectionPrompt.Layer.Run.MouseButton1Click:Connect(function()
				closeGameDetection()
				queueNotification("Menjalankan "..gameFound.name, "Sekarang menjalankan script "..gameFound.name.." Sirius, ini mungkin memakan waktu sebentar.", 4400701828)
				runScript(rawFile)
...
local function sortActions()	
	...
	for _, action in ipairs(siriusValues.actions) do
		...
		characterPanel.Interactions.Grid.MouseLeave:Connect(function()
			characterPanel.Interactions.ActionsTitle.Text = "TINDAKAN PEMAIN"
		end)
		...
		newAction.Interact.MouseButton1Click:Connect(function()
			...
			if not success then
				queueNotification("Kesalahan Tindakan", "Tindakan ini ('"..(action.name).."') mengalami kesalahan saat berjalan, harap laporkan ini ke tim Sirius di sirius.menu/discord", 4370336704)
				action.enabled = false
				newAction.Icon.Image = "rbxassetid://"..action.images[2]
				tweenService:Create(newAction, TweenInfo.new(0.4, Enum.EasingStyle.Exponential), {BackgroundTransparency = 0.55}):Play()
				tweenService:Create(newAction.UIStroke, TweenInfo.new(0.4, Enum.EasingStyle.Exponential), {Transparency = 0.4}):Play()
...
local function rejoin()
	queueNotification("Bergabung Kembali ke Sesi", "Kami sedang mengantri untuk bergabung kembali ke sesi ini, beri kami waktu sebentar.", 4400696294)
...
local function serverhop()
	...
	if #servers > 0 then
		queueNotification("Menteleportasi", "Kami sekarang memindahkan Anda ke sesi baru, ini mungkin memakan waktu beberapa detik.", 4335479121)
		task.wait(0.3)
		teleportService:TeleportToPlaceInstance(placeId, servers[1])
	else
		return queueNotification("Tidak Ada Server Ditemukan", "Kami tidak dapat menemukan server lain, ini mungkin satu-satunya server.", 4370317928)
	end
...
local function ensureFrameProperties()
	...
	musicPanel.Playing.Text = "Tidak Memutar"
...
local function checkFriends()
	if friendsCooldown == 0 then
		...
		homeContainer.Interactions.Friends.All.Value.Text = tostring(friendsInTotal).." teman"
		homeContainer.Interactions.Friends.Offline.Value.Text = tostring(friendsInTotal - onlineFriends).." teman"
		homeContainer.Interactions.Friends.Online.Value.Text = tostring(onlineFriends).." teman"
		homeContainer.Interactions.Friends.InGame.Value.Text = tostring(friendsInGame).." teman"
...
local function UpdateHome()
	...
	-- Home Title
	homeContainer.Title.Text = "Selamat datang, "..localPlayer.DisplayName

	-- Players
	homeContainer.Interactions.Server.Players.Value.Text = #players:GetPlayers().." sedang bermain"
	homeContainer.Interactions.Server.MaxPlayers.Value.Text = players.MaxPlayers.." pemain dapat bergabung ke server ini"
	...
	-- Region
	homeContainer.Interactions.Server.Region.Value.Text = "Tidak dapat mengambil wilayah"
	...
	if not table.find(siriusValues.executors, string.lower(identifyexecutor())) then
		homeContainer.Interactions.Client.Subtitle.Text = "Executor ini tidak diverifikasi sebagai didukung - tetapi mungkin masih berfungsi dengan baik."
	end
...
local function openScriptSearch()
	...
	scriptSearch.SearchBox.PlaceholderText = "Cari ScriptBlox.com"
...
local function createScript(result)
	...
	task.spawn(function()
		...
		if likes ~= dislikes then
			newScript.Tags.Review.Title.Text = (likes > dislikes) and "Ulasan Positif" or "Ulasan Negatif"
		...
		elseif likes > 0 then
			newScript.Tags.Review.Title.Text = "Ulasan Campuran"
		...
		newScript.ScriptAuthor.Text = "diunggah oleh "..response.script.owner.username
	...
	newScript.Execute.MouseButton1Click:Connect(function()
		queueNotification("ScriptSearch", "Menjalankan "..result.title.. " via ScriptSearch" , 4384403532)
		closeScriptSearch()
...
if Essential or Pro then
	getgenv()[index] = function(data)
		if checkSirius() and checkSetting("Intelligent HTTP Interception").current then
			local title = "Apakah Anda mempercayai sumber ini?"
			local content = "Sirius telah mencegah data dikirim dari klien, apakah Anda ingin mengizinkan data dikirim atau diambil dari sumber ini?"
			local url = data.Url or "Tautan Tidak Dikenal"
			...
			local actions = {{"Selalu Izinkan", true, true}, {"Izinkan hanya sekali ini", true}, {"Jangan Izinkan", false}}
			...
			if url == "http://127.0.0.1:6463/rpc?v=1" then
				...
				if bodyDecoded.cmd == "INVITE_BROWSER" then
					title = "Apakah Anda ingin bergabung dengan server Discord ini?"
					content = "Sirius telah mencegah klien Discord Anda dari bergabung otomatis dengan server Discord ini, apakah Anda ingin melanjutkan dan bergabung, atau memblokirnya?"
					url = bodyDecoded.args and "discord.gg/"..bodyDecoded.args.code or "Undangan Tidak Dikenal"
					...
					actions = {{"Izinkan", true}, {"Jangan Izinkan", false}}
				end
			end
	...
	getgenv()[indexSetClipboard] = function(data)
		if checkSirius() and checkSetting("Intelligent Clipboard Interception").current then
			local title = "Apakah Anda ingin menyalin ini ke clipboard Anda?"
			local content = "Sirius telah mencegah script mengatur teks di bawah ini ke clipboard Anda, apakah Anda ingin mengizinkan ini, atau mencegahnya dari penyalinan?"
			local url = data or "Clipboard Tidak Dikenal"
			...
			local actions = {{"Izinkan", true}, {"Jangan Izinkan", false}}
...
local function searchScriptBlox(query)
	...
	if not success then
		queueNotification("ScriptSearch", "Backend ScriptSearch mengalami kesalahan, coba lagi nanti", 4384402990)
		closeScriptSearch()
		return
	end
...
local function teleportTo(player)
	if players:FindFirstChild(player.Name) then
		queueNotification("Teleportasi", "Menteleportasi ke "..player.DisplayName..".")
		...
		queueNotification("Kesalahan Teleportasi", player.DisplayName.." telah meninggalkan server ini.")
	end
end
...
local function createPlayer(player)
	...
	if creatorType == Enum.CreatorType.Group then
		task.spawn(function()
			...
			if role == "Guest" then
				newPlayer.Role.Text = "Peringkat Grup: Tidak Ada"
			else
				newPlayer.Role.Text = "Peringkat Grup: "..role
			end
	...
	newPlayer.PlayerInteractions.Kill.Interact.MouseButton1Click:Connect(function()
		queueNotification("Notifikasi Simulasi","Mensimulasikan Notifikasi Kill untuk "..player.DisplayName..".")
	...
	newPlayer.PlayerInteractions.Spectate.Interact.MouseButton1Click:Connect(function()
		queueNotification("Notifikasi Simulasi","Mensimulasikan Notifikasi Spectate untuk "..player.DisplayName..".")
		-- Spectate
	end)

	newPlayer.PlayerInteractions.Locate.Interact.MouseButton1Click:Connect(function()
		queueNotification("Notifikasi Simulasi","Mensimulasikan Notifikasi Locate ESP untuk "..player.DisplayName..".")
...
local function openSettings()
	...
	settingsPanel.Title.Text = "Pengaturan"
	settingsPanel.Subtitle.Text = "Sesuaikan preferensi Anda, atur tombol pintas baru, uji fitur baru dan lainnya."
			...
			if not setting.hidden then
				...
				if settingType == "Boolean" then
					...
					newSwitch.Interact.MouseButton1Click:Connect(function()
						if minimumLicense then
							if (minimumLicense == "Pro" and not Pro) or (minimumLicense == "Essential" and not (Pro or Essential)) then
								queueNotification("Fitur ini terkunci", "Anda harus "..minimumLicense.." atau lebih tinggi untuk menggunakan "..setting.name..". \n\nTingkatkan di https://sirius.menu.", 4483345875)
								return
							end
						end
				...
				elseif settingType == "Input" then
					...
					newInput.InputFrame.InputBox.PlaceholderText = setting.placeholder or "masukan"
				...
				elseif settingType == "Number" then
					...
					newInput.InputFrame.InputBox.PlaceholderText = setting.placeholder or "angka"
					newInput.Parent = newList
				...
				elseif settingType == "Key" then
					...
					newKeybind.InputFrame.InputBox.PlaceholderText = setting.placeholder or "mendengarkan.."
					...
					newKeybind.InputFrame.InputBox.FocusLost:Connect(function()
						...
						if newKeybind.InputFrame.InputBox.Text == nil or newKeybind.InputFrame.InputBox.Text == "" then
							newKeybind.InputFrame.InputBox.Text = "Tidak Ada Tombol Pintas"
							setting.current = nil
				...
				if object then
					...
					if minimumLicense then
						...
						object.LicenseDisplay.Text = string.upper(minimumLicense).." FITUR"
					end
		...
		if hookmetamethod then 
			...
			originalIndex = hookmetamethod(game, "__index", function(self, method)
				if self == localPlayer and method:lower() == "kick" and checkSetting("Client-Based Anti Kick").current and checkSirius() then
					queueNotification("Kick Dicegah", "Sirius telah mencegah Anda dari dikick oleh klien.", 4400699701)
...
local function start()
	if siriusValues.releaseType == "Experimental" then -- Make this more secure.
		if not Pro then localPlayer:Kick("Ini adalah rilis eksperimental, Anda harus Pro untuk menjalankan ini. \n\nTingkatkan di https://sirius.menu/") return end
	end
	...
	if script_key and not (Essential or Pro) then
		queueNotification("Kesalahan Lisensi", "Kami telah mendeteksi kunci ditempatkan di atas loadstring Sirius, namun kunci Anda tampaknya tidak valid. Buat permintaan dukungan di sirius.menu/discord untuk menyelesaikan ini dalam hitungan menit.", "document-minus")
	end
...
characterPanel.Interactions.Reset.MouseButton1Click:Connect(function()
	...
	queueNotification("Nilai Slider Direset","Berhasil mereset semua slider panel karakter", 4400696294)
...
game:GetService("TeleportService"):TeleportToPlaceInstance(']]..placeId..[[', ']]..jobId..[[')]]
		...
		queueNotification("Script Bergabung Disalin","Berhasil mengatur clipboard ke script bergabung, pemain dapat menggunakan script ini untuk bergabung ke server spesifik Anda.", 4335479121)
	else
		queueNotification("Tidak dapat menyalin script bergabung","Fungsi setclipboard() tidak ada, tidak dapat mengatur data ke clipboard Anda.", 4335479658)
	end
end)
...
homeContainer.Interactions.Discord.Interact.MouseButton1Click:Connect(function()
	if setclipboard then 
		...
		queueNotification("Undangan Discord Disalin", "Kami telah mengatur clipboard Anda ke undangan discord Sirius.", 4335479121)
	else
		queueNotification("Tidak dapat menyalin undangan Discord", "Fungsi setclipboard() tidak ada, tidak dapat mengatur data ke clipboard Anda.", 4335479658)
	end
end)
...
players.PlayerAdded:Connect(function(player)
	...
	if checkSetting("Log PlayerAdded and PlayerRemoving").current then
		local logData = {
			["content"] = player.DisplayName.." (@"..player.Name..") meninggalkan server.",
			["avatar_url"] = "https://www.roblox.com/headshot-thumbnail/image?userId="..player.UserId.."&width=420&height=420&format=png",
			["username"] = player.DisplayName,
			["allowed_mentions"] = {parse = {}}
		}
		...
		if siriusValues.currentCreator == "group" then
			for _, role in pairs(siriusValues.administratorRoles) do 
				if string.find(string.lower(roleFound), role) then
					...
					queueNotification("Administrator Bergabung", siriusValues.currentGroup .." "..roleFound.." ".. player.DisplayName .." telah bergabung ke sesi Anda", 3944670656) -- change to group name
				end
			end
		end
	end
	...
	if checkSetting("Friend Notifications").current then
		if localPlayer:IsFriendsWith(player.UserId) then
			queueNotification("Teman Bergabung", "Teman Anda "..player.DisplayName.." telah bergabung ke server Anda.", 4370335364)
		end
	end
end)
...
players.PlayerRemoving:Connect(function(player)
	if checkSetting("Log PlayerAdded and PlayerRemoving").current then
		local logData = {
			["content"] = player.DisplayName.." (@"..player.Name..") bergabung ke server.",
			["avatar_url"] = "https://www.roblox.com/headshot-thumbnail/image?userId="..player.UserId.."&width=420&height=420&format=png",
			["username"] = player.DisplayName,
			["allowed_mentions"] = {parse = {}}
		}
			...
			for index, sound in next, soundInstances do
				...
				elseif gameSettings.MasterVolume * sound.PlaybackLoudness * sound.Volume >= tonumber(checkSetting("Spatial Shield Threshold").current) then
					...
					if soundSuppressionNotificationCooldown == 0 then
						queueNotification("Perisai Spasial","Audio volume tinggi sedang diputar ("..sound.Name..") dan telah ditekan.", 4483362458) 
...
while task.wait(1) do
	...
	if disconnectedRobloxUI and not promptedDisconnected then
		...
		if disconnectType == "ban" then
			disconnectedPrompt.Content.Text = "Anda telah dilarang, apakah Anda ingin meninggalkan server ini?"
			disconnectedPrompt.Action.Text = "Tinggalkan"
		...
		elseif disconnectType == "kick" then
			disconnectedPrompt.Content.Text = "Anda telah dikick, apakah Anda ingin pindah server?"
			disconnectedPrompt.Action.Text = "Pindah Server"
		...
		elseif disconnectType == "network" then
			disconnectedPrompt.Content.Text = "Anda kehilangan koneksi, apakah Anda ingin bergabung kembali?"
			disconnectedPrompt.Action.Text = "Bergabung Kembali"
		...
		if checkHighPing() then
			if siriusValues.pingProfile.pingNotificationCooldown <= 0 then
				if checkSetting("Adaptive Latency Warning").current then
					queueNotification("Peringatan Latensi Tinggi","Kami telah memperhatikan latensi Anda telah mencapai nilai yang lebih tinggi dari biasanya, Anda mungkin menemukan bahwa Anda mengalami lag atau tindakan Anda tertunda di dalam game. Pertimbangkan untuk memeriksa unduhan latar belakang di mesin Anda.", 4370305588)
			...
			if #siriusValues.frameProfile.fpsQueue > 0 then
				...
				if avgFPS < siriusValues.frameProfile.lowFPSThreshold then
					if checkSetting("Adaptive Performance Warning").current then
						queueNotification("Performa Menurun","Kami telah memperhatikan frame per detik klien Anda telah menurun. Pertimbangkan untuk memeriksa tugas atau program latar belakang di mesin Anda.", 4384400106)
